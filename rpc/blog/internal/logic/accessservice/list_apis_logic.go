...
func (l *ListApisLogic) ListApis(in *accessrpc.ListApisRequest) (*accessrpc.ListApisResponse, error) {
	...
	out := &accessrpc.ListApisResponse{
...
func appendApiChildren(root *accessrpc.Api, list []*model.TApi) (leafs []*accessrpc.Api) {
