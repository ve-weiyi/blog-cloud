...
// 点赞文章
func (l *LikeArticleLogic) LikeArticle(in *contentrpc.LikeArticleRequest) (*contentrpc.LikeArticleResponse, error) {
	...
	return &contentrpc.LikeArticleResponse{Success: true}, nil
}
