...
func (l *QueryRoleListLogic) QueryRoleList(req *types.QueryRoleListReq) (resp *types.ListResult, err error) {
	out, err := l.svcCtx.AccessService.ListRoles(l.ctx, &accessservice.ListRolesRequest{})
	if err != nil {
		return nil, err
	}
