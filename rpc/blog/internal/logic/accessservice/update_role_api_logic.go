...
// 更新角色 API 资源
func (l *UpdateRoleApiLogic) UpdateRoleApi(in *accessrpc.UpdateRoleApiRequest) (*accessrpc.UpdateRoleApiResponse, error) {
	...
	return &accessrpc.UpdateRoleApiResponse{Success: true}, nil
}
