...
// 查询用户 API 权限
func (l *GetUserApisLogic) GetUserApis(in *accessrpc.GetUserApisRequest) (*accessrpc.GetUserApisResponse, error) {
	...
	if len(roleIds) == 0 {
		return &accessrpc.GetUserApisResponse{}, nil
	}
	...
	out := &accessrpc.GetUserApisResponse{}
	for _, a := range apis {
