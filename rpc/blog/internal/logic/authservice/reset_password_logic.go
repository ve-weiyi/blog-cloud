...
// 重置密码
func (l *ResetPasswordLogic) ResetPassword(in *authrpc.ResetPasswordRequest) (*authrpc.ResetPasswordResponse, error) {
	// 校验邮箱格式
	...
	// 更新密码
	hashedPassword, err := cryptox.BcryptHash(in.Password)
	if err != nil {
		return nil, err
	}
	...
	return &authrpc.ResetPasswordResponse{}, nil
}
