...
func (l *GetDashboardStatsLogic) GetDashboardStats(in *statsrpc.GetDashboardStatsRequest) (*statsrpc.GetDashboardStatsResponse, error) {
	...
	return &statsrpc.GetDashboardStatsResponse{
		UserCount:      userCount,
