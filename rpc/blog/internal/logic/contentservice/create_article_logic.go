...
// 创建文章
func (l *CreateArticleLogic) CreateArticle(in *contentrpc.CreateArticleRequest) (*contentrpc.CreateArticleResponse, error) {
	...
	return &contentrpc.CreateArticleResponse{
		Id: entity.Id,
	}, nil
}
