...
// 查询用户菜单权限
func (l *GetUserMenusLogic) GetUserMenus(in *accessrpc.GetUserMenusRequest) (*accessrpc.GetUserMenusResponse, error) {
	...
	if len(roleIds) == 0 {
		return &accessrpc.GetUserMenusResponse{}, nil
	}
	...
	out := &accessrpc.GetUserMenusResponse{}
	for _, m := range menus {
