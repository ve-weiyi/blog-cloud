...
// 创建照片
func (l *CreatePhotoLogic) CreatePhoto(in *mediarpc.CreatePhotoRequest) (*mediarpc.CreatePhotoResponse, error) {
	entity := &model.TPhoto{
		AlbumId:   in.AlbumId,
	...
	return &mediarpc.CreatePhotoResponse{Id: entity.Id}, nil
}
